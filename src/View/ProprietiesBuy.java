...
public class ProprietiesBuy extends javax.swing.JDialog {
    ...
    public ProprietiesBuy(java.awt.Frame parent, boolean modal,int position,PlayersWindowSix windowSix) {
        super(parent, modal);
        initComponents();
        this.position = position;
        this.parent = parent;
    ...
    public ProprietiesBuy(java.awt.Frame parent, boolean modal,int position,PlayersWindowFive windowSix) {
        super(parent, modal);
        initComponents();
        this.position = position;
        this.parent = parent;
        this.windowFive=windowSix;
        this.player = AppManager.INSTANCE.getPlayers(position);
        init();
    }
